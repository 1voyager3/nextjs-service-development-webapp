    ...
    return (
        <Grid container direction="row">
            ...
            <Head>
                ...
                <title key="title">Free Estimate | Demo Development</title>
                <meta
                    name="description"
                    key="description"
                ...
                <meta
                    property="og:title"
                    key="og:title"
                    content="Bringing West Coast Technology to the Midwest | Free Estimate Development"
                />
                <meta
                    property="og:url"
                    key="og:url"
                    content="https://example.com/estimate"
                />

                {/* Canonical Tag */}
                <link
                    href="https://example.com/estimate"
                    rel="canonical"
                    key="canonical"
                />
            </Head>

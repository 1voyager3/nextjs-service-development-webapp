    ...
    return (
        <Grid container direction="column">
            ...
            <Head>
                ...
                <title key="title">
                    iOS/Android App Design and Development | Demo Development
                </title>
                <meta
                    name="description"
                    key="description"
                    content="Mobile Apps Made Easy | Our cutting-edge mobile app development process lets us build
                ...
                <meta
                    property="og:title"
                    key="og:title"
                    content="Bringing West Coast Technology to the Midwest | iOS/Android App Design and Development"
                />
                <meta
                    property="og:url"
                    key="og:url"
                    content="https://example.com/mobileapps"
                />

                {/* Canonical Tag */ }
                <link
                    href="https://example.com/mobileapps"
                    rel="canonical"
                    key="canonical"
                />
            </Head>

    ...
    return (
        <Grid container direction="column" className={ classes.mainContainer }>
            ...
            <Head>
                ...
                <title key="title">
                    Custom Software, Mobile Apps, and Websites | Demo Development
                </title>
                <meta
                    name="description"
                    key="description"
                    content="Pristine software custom-designed from the ground up and developed with cutting-edge
                    optimizations. Use our free estimate calculator to check your project cost!"
                />
                ...
                <meta
                    property="og:title"
                    key="og:title"
                    content="Bringing West Coast Technology to the Midwest | Demo Development"
                />
                <meta
                    property="og:url"
                    key="og:url"
